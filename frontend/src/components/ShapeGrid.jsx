...
/**
 * @typedef {string | CanvasGradient | CanvasPattern} CanvasStrokeStyle
 */
...
/**
 * @typedef {Object} ShapeGridProps
 * @property {'diagonal' | 'up' | 'right' | 'down' | 'left'} [direction='right']
 * @property {number} [speed=1]
 * @property {CanvasStrokeStyle} [borderColor='#999']
 * @property {number} [squareSize=40]
 * @property {CanvasStrokeStyle} [hoverFillColor='#222']
 * @property {'square' | 'hexagon' | 'circle' | 'triangle'} [shape='square']
 * @property {number} [hoverTrailAmount=0]
 */

/**
 * Animated grid background component with interactive hover effects
 * @param {ShapeGridProps} props
 */
const ShapeGrid = ({
    direction = 'right',
    speed = 1,
